...
describe User do
 ...
 it { should respond_to(:entris) }
  ...
  describe "profile page" do
    ...
    let!(:m1) { FactoryGirl.create(:entry, user: user, content: "Foo" , title: "Foo") }
    let!(:m2) { FactoryGirl.create(:entry, user: user, content: "Bar" , title:"Bar") }
